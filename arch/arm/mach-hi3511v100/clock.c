/* linux/arch/arm/mach-hi3511_v100/clock.c
*
	...
	void *data)
{
	*my_first_byte = page_buffer;
	return clk_info(page_buffer, length);
}
#endif
...
static int __init clk_info_init(void)
{
	...
	create_proc_read_entry("clocks", 0444, NULL, clk_proc_get_info, NULL);
