/* linux/include/asm-arm/arch-hi3511_v100_f01/hardware.h
*
...
#define __ASM_ARCH_HARDWARE_H 
	...
	#define HISILICON_OSC_CLOCK	40000000
#else
...
#define __IO_ADDRESS(x) ( \
		__IO_ADDRESS_T(x, 0x10100000, 0x00100000, 0x00100000) + \
		__IO_ADDRESS_T(x, 0x80000000, 0x00100000, 0x00200000) + \
		__IO_ADDRESS_T(x, 0x90000000, 0x00100000, 0x00300000) + \
		__IO_ADDRESS_T(x, 0xA0000000, 0x00100000, 0x00400000) + \
