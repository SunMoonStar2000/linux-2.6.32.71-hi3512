...
#define blkdev_fsync	block_fsync
...
enum {
	...
	DIO_NO_LOCKING = 2,  /* bdev; no locking at all between buffered/direct */
	DIO_OWN_LOCKING = 2, /* filesystem locks buffered and direct internally */
	DIO_SKIP_HOLES = 2, /* filesystem does not support filling holes */
};
